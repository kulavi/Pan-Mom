//Activity Tab containing two tabs as Enter Activity and Log
...
public class Activitytab extends Custom_window_tab {
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // btnhome=(Button) findViewById(R.id.icon);
        ...
        Intent i=new Intent(this,Enter_Activity_data.class);
        ...
        i.putExtras(bun1);
        firstTabSpec.setIndicator("Activity").setContent(i);
        
        
        Intent i1=new Intent(this,View_Activity_Log.class);
        Bundle bun2=new Bundle();
        bun2.putString("UNAME", struname);
        bun2.putInt("USERID", intuserid);
        i1.putExtras(bun2);
        secondTabSpec.setIndicator("Activity Log").setContent(i1);
