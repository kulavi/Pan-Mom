//HB Tab containing two tabs as Enter HB and Log
...
public class HBtab extends Custom_window_tab {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //Setting activities to tabs
        Intent i=new Intent(this,Enter_HB_data.class);
        ...
        i.putExtras(bun1);
        firstTabSpec.setIndicator("Hemoglobin").setContent(i);
        
        
        Intent i1=new Intent(this,View_HB_Log.class);
        Bundle bun2=new Bundle();
        bun2.putString("UNAME", struname);
        bun2.putInt("USERID", intuserid);
        i1.putExtras(bun2);
        secondTabSpec.setIndicator("Hemoglobin Log").setContent(i1);
